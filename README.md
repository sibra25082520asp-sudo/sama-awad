...
<li>Become surgean doctor</li>
    ...
    <h2>My Best Work</h2>
    <p>
Some of my best work is drawing and crocheting. I like drawing different things in my free time.  I also enjoy crocheting because I like making things with my hands. 
</p>
...
background:linear-gradient(to right,#1e4c72,#2a9298);
color:white;
}
